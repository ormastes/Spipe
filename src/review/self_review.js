...
export const selfReviewProviderGuidance = Object.freeze({
  ...
  admission_action: "emit the broker-owned SPipe Self Review Admission required check for the exact admitted revision",
