...
export const selfReviewSchemas = Object.freeze({ request: "spipe-self-review-request/2", policy_db: "spipe-self-review-policy-db/1", subject_policy: "spipe-self-review-subject-policy/1", path_manifest: "spipe-changed-path-manifest/1", resolution: "spipe-self-review-resolution/2", decision: "spipe-self-review-decision/2", admission_command: "spipe-self-review-admission-command/2", admission: "spipe-self-review-admission/2" });
