...
function sessionInput() { return { session_id: "s-release-001", workspace_path: "/tmp", main_workspace_path: root, work_branch: "work/release/v1.2.0-beta.1-s-release-001", target_ref: "release/1.2", base_sha: sha, expected_target_sha: sha2, policy_sha256: hash }; }
...
test("guarded planners fail closed on unsafe requests", () => {
  ...
  assert.throws(() => createReleasePlan("isolated-session", { ...sessionInput(), workspace_path: `/proc/self/root${root}` }), /physical main worktree/);
