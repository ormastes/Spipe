...
export const tools = Object.freeze([
  ...
  { name: "spipe_self_review_guide", description: "Explain why GitHub authors cannot APPROVE their own pull requests and how the distinct expiring SPipe Self Review Admission check binds authorization, scope, denial, and invalidation.", inputSchema: { type: "object", properties: {}, additionalProperties: false } },
